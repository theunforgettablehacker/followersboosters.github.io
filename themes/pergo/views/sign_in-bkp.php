      ...
      <div>
        ...
        <div class="form-group">
          ...
          <div class="input-icon mb-5">
            ...
            <span>Email</span>
            <input type="email" class="form-control" name="email" placeholder="<?=lang("Enter_you_email")?>" value="<?=(isset($cookie_email) && $cookie_email != "") ? $cookie_email : ""?>" required>
          </div>    
          ...
          <div class="input-icon mb-5">
            ...
            <span>Password</span>
            <input type="password" class="form-control" name="password" placeholder="<?=lang("Enter_you_password")?>" value="<?=(isset($cookie_pass) && $cookie_pass != "") ? $cookie_pass : ""?>" required>
          </div>  
