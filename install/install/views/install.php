                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="./index.php/ajax_install" method="post">
                                ...
                                <div class="section clearfix">
                                    <p>1. Please enter your database connection details.(Nulled by https://smmpanels.store)</p>
                                    <hr />
                                    <div>
                                ...
                                <div class="section clearfix">
                                    <p>2. Please enter your account details for administration.(Nulled by https://smmpanels.store)</p>
                                    <hr />
                                    <div>
                                ...
                                <div class="section clearfix">
                                    <p>3. Please enter your item purchase code.(Type Something)</p>
                                    <hr />
                                    <div>
                                        <div class="form-group clearfix">
                                            <label for="purchase_code" class=" col-md-3">Item purchase code</label>
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="https://smmpanels.store" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed SmartPanell v.3.2 by SmmPanels.Store<?=$project_name?></span>  
                                </div>

                                <div style="margin: 15px 0 15px 60px; color: #d73b3b;">
                                    Now delete your installation directory & clear your cache - Nulled by https://smmpanels.store
                                </div>
